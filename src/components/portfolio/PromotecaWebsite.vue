    ...
    <div class="projects-container modern-websites pt-24 pb-56 mb-24">
      ...
      <div class="wide-wrapper flex flex-wrap justify-center items-center gap-4 my-6">
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca01.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca02.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca03.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca04.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca05.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca06.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca07.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca08.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
        ...
        <div class="relative border border-1 border-purple-600">
          <img
            src="./../../assets/img/portfolio/promoteca/promoteca09.jpg"
            alt="PROMOTECA.pl"
            width="410"
            height="205"
            class="h-auto"
